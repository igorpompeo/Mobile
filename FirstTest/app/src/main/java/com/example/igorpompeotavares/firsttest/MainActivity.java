package com.example.igorpompeotavares.firsttest;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.button_calculate){
            ...
            this.mViewHolder.textDollar.setText(String.format("%.2f", value * 3,843));
            this.mViewHolder.textEuro.setText(String.format("%.2f", value * 4,457));
        }
    }
